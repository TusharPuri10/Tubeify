	...
	return (
		<div className="min-h-screen  flex flex-col items-center justify-between bg-black">
			...
			>
				...
				{overlay && (
					<div className="h-fit w-full bg-opacity-10 rounded-lg flex md:flex-row flex-col justify-around">
						{/* youtube video */}
			...
			{/* Footer */}
			<footer className="flex w-full justify-between flex-wrap   p-4 bg-black">
